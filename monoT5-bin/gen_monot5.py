...
if demo ==1 :
    ...
    file_newrun = 'monoT5-bin/run/runT5v1-' + str(model_n) + '.dl20demo.txt'
else:
    file_run = 'baseline/run.dl20.txt'
    file_newrun = 'monoT5-bin/run/runT5v1-' + str(model_n) + '.dl20.txt'
...
with open(file_run, encoding='utf8') as f:
    for line in f:
        ...
        fname = 'monoT5-bin/chk/model-' + str(model_n) + '/out2/output' + str(id) + '.json'
