...
class MyGenOut():
    ...
    def run(self, model_n_in):
        ...
        tokenizer = T5Tokenizer.from_pretrained("monoT5-bin-plus/chk/model-" + str(model_n))
        model = T5ForConditionalGeneration.from_pretrained("monoT5-bin-plus/chk/model-" + str(model_n))
        ...
        if demo ==1 :
            file_run = 'rerankgpt3-1k/baseline/run.dl20demo.txt'
        else:
            file_run = 'rerankgpt3-1k/baseline/run.dl20.txt'
            ...
            for line in f:
                if id >= 0:
                    ...
                    if run_monoT5 ==1:
                        ...
                        fj = open("monoT5-bin-plus/chk/model-" + str(model_n) + "/out2/output" + str(id) + ".json","w")
